#ifndef ATOM_PARAM_VECTOR_MULT_H
#define ATOM_PARAM_VECTOR_MULT_H

#include "bivariate.h"
#include "common.h"

/* Parameter vector elementwise multiplication: p ∘ f(x) where p is a parameter node */
static PyObject *py_make_param_vector_mult(PyObject *self, PyObject *args)
{
    ...
    expr *node = new_param_vector_mult(param_node, child);
    if (!node)
    {
        PyErr_SetString(PyExc_RuntimeError,
                        "failed to create param_vector_mult node");
        return NULL;
    }
...
#endif /* ATOM_PARAM_VECTOR_MULT_H */
